...
import { z } from 'zod'
import { PASSWORD_REGEX, USERNAME_REGEX } from '~/global/constants/regex.ts'
...
const userZod = z.object({
  ...
  password: z
    ...
    .regex(PASSWORD_REGEX, {
      message:
        'Password must include at least one special character (e.g., !, @, #, $), both uppercase and lowercase letters, and at least one digit'
    }),
